--TEST--
Singleton teardown: subprocess holding live singleton wrappers until exit
--SKIPIF--
...
$script = __DIR__ . '/050-singleton-teardown-sub.php';
...
Output:
  ...
  e: E
  two: 2
  OK: singleton teardown test completed
PASS: clean exit
